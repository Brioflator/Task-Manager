...
//preluat din lab to some degree
    ...
    public static class SeedData
    {
        public static void Initialize(IServiceProvider serviceProvider)
        {
                ...
                <DbContextOptions<ApplicationDbContext>>()))
            {
                ...
                // Facem return pentru a nu insera rolurile inca o data
                // Trebuie sa se execute o singura data 
                ...
                context.Users.AddRange(
                    new ApplicationUser
                    {
                        Id = "8e445865-a24d-4543-a6c6-9443d048cdb0", // PK
                        FirstName = "ADMIN",
                        LastName = "admin",
                    ...
                    new ApplicationUser
                    {
                        Id = "8e445865-a24d-4543-a6c6-9443d048cdb1", // PK
                        FirstName = "EDITOR",
                        LastName = "editor",
                    ...
                    new ApplicationUser
                    {
                        Id = "8e445865-a24d-4543-a6c6-9443d048cdb2", // PK
                        FirstName = "USER",
                        LastName = "user",
